    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-start mb-3">
          ...
          <div class="align-self-center mr-2">
            <button type="button" class="btn btn-info" @click="onCreate" v-if="!disabled">
        ...
        <table class="table-custom" key="processes">
          <thead>
            <tr>
              ...
              <th class="text-center bg-primary text-white">得意先名</th>
            ...
            >
              ...
              <td class="text-center">
                <div
                  ...
                  :key="index"
                >{{report_detail.customer_name}}</div>
              </td>
              <td class="text-center">
                <div
                  v-for="(report_detail, index) in report.report_details"
                  :key="index"
                >{{report_detail.item_name}}</div>
              </td>
            </tr>
          </tbody>
        </table>
